...
const FAQItem: React.FC<{ question: string; answer: string; index: number }> = ({ question, answer, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="mt-4 leading-relaxed pl-8">{answer}</p>
      </motion.div>
    </motion.div>
  );
};
    ...
    <div className="bg-background text-foreground font-sans">
      ...
      <section className="py-16 px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <MdRealEstateAgent className="text-5xl text-orange-500" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 bg-muted">
        <div className="max-w-5xl mx-auto">
          ...
          <motion.ul 
            className="text-xl text-muted-foreground space-y-4 mt-8 px-4 md:px-0"
          ...
          >
            {[
              { text: "Ensure your properties are well-maintained with reliable support.", icon: <FaTools className="text-orange-500 mr-3" /> },
              { text: "Promptly procure fixtures and repairs for seamless upkeep.", icon: <FaClipboardList className="text-orange-500 mr-3" /> },
              { text: "Expertly manage legal documentation with our dedicated legal team.", icon: <FaShieldAlt className="text-orange-500 mr-3" /> },
              { text: "Provide seamless rent collection and accurate reconciliation.", icon: <FaHandHoldingUsd className="text-orange-500 mr-3" /> },
            ].map((item, index) => (
              <motion.li 
                key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            >
              <div className="mb-6 flex items-start">
                <GiHouseKeys className="text-3xl text-orange-500 mr-4 mt-1" />
                <div>
                  <h3 className="text-2xl font-bold mb-2">Property Management</h3>
              ...
              <div className="mb-6 flex items-start">
                <FaBuilding className="text-3xl text-orange-500 mr-4 mt-1" />
                <div>
                  <h3 className="text-2xl font-bold mb-2">Foreclosure Services</h3>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="flex items-start">
                <FaSearchDollar className="text-3xl text-orange-500 mr-4 mt-1" />
                <div>
                  <h3 className="text-2xl font-bold mb-2">Investment Consulting</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Strategic advice to maximize your real estate investment portfolio returns.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 px-8">
        <div className="max-w-6xl mx-auto">
          <motion.h2 
            ...
            transition={{ duration: 0.6 }}
          >
            What Makes Us Stand Out in <span className='text-orange-500'>Property Management</span> 
          </motion.h2>
          <motion.div 
            className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8"
            variants={staggerChildren}
      ...
      <section className="py-16 bg-card px-8">
